			...
			<div class="dropdown">
			  ...
			  <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
			  	<div class="dropdown-links">
				    <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo $url ?>../../category1/index.php">Communication et Signalétique</a></li>
				    <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo $url ?>../../category2/index.php">Articles de mairie</a></li>
				    <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo $url ?>../../category3/index.php">Drapeaux, mâts et supports</a></li><br>
			...
			<ul class="menu-md">
				<div class="row">
					<div class="col-md-6 link-1">
						<li><h2><a href="<?php echo $url ?>../../category1/index.php">Communication et signalétique</a></h2></li>
					</div>
					<div class="col-md-6 link-2">
						<li><h2><a href="<?php echo $url ?>../../category2/index.php">Articles de mairie</a></h2></li>
					</div>
				</div>
			</ul>
		</div>
			...
			<ul class="menu-md">
				<div class="row">
					<div class="col-md-6 link-3">
						<li><h2><a href="<?php echo $url ?>../../category3/index.php"	>Drapeaux, mâts et supports</a></h2></li>
					</div>
